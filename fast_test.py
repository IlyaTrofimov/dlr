...
if __name__ == '__main__':
	execute('./dlr -d small_train_ro_0.1.ii2 -i ethalon_model --iterations 10 --termination 0.0 --lambda-1 16 -f tmp_model --last-iter-sum --linear-search 1 -l small_train_ro_0.1.label')
